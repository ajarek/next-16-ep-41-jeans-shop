          ...
          <div className='flex-1 p-6 sm:p-8 overflow-y-auto max-h-[50vh] md:max-h-[90vh] bg-[#FDFCFB]'>
              ...
              <div className='flex items-center gap-4 mb-6'>
                ...
                <div>
                  ...
                  <p className='text-[10px] text-[#2B3E50] font-black uppercase tracking-wider mt-1.5'>
                    Krok {step} z 2:{" "}
                    {step === 1 ? "Adres dostawy" : "Szybka płatność online"}
                  </p>
                </div>
              </div>
            )}
            ...
            {step === 1 && (
              <form onSubmit={handleNextStep} className='space-y-4'>
                ...
                <div className='space-y-1.5'>
                  <label className='text-[10px] font-black text-stone-900 uppercase tracking-widest'>
                    Telefon kontaktowy
                    <span className='text-[9px] text-stone-400 lowercase italic ml-1'>
                      Do kuriera
                    </span>
                  </label>
                  <input
            ...
            {step === 2 && (
              <div className='space-y-6'>
                ...
                <div className='grid grid-cols-3 gap-2 text-center text-xs'>
                  {[
                    ...
                    },
                    {
                      ...
                      label: "BLIK",
                      icon: (
                        <span className='font-sans font-black text-[10px] tracking-tight text-stone-900 leading-none'>
                          BLIK
                        </span>
                      ),
                    },
                  ...
                  <div className='space-y-4 bg-white p-4 border-2 border-black rounded-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <p className='text-[10px] text-stone-600 font-bold text-center leading-relaxed uppercase tracking-wider'>
                        Wygeneruj kod w swojej aplikacji bankowej, wpisz go
                        tutaj i zaakceptuj transakcję na telefonie.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {paymentMethod === "Przelew" && (
                  <div className='space-y-4 bg-white p-4 border-2 border-black rounded-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'>
                    ...
                    <div className='grid grid-cols-2 gap-2 text-center text-xs font-bold uppercase tracking-wider'>
                      {["PKO BP", "mBank", "ING Bank", "Pekao SA"].map(
                        (bank) => (
                          <button
                            key={bank}
                            onClick={() =>
                              alert(
                                `Po kliknięciu sfinalizowania nastąpi przekierowanie i automatyczna autoryzacja z banku ${bank}.`,
                              )
                            }
                ...
                >
                  <span>Zapłać zł{finalTotal.toFixed(2)} i zamów</span>
                </button>
                ...
                <div className='flex items-center justify-center gap-1.5 text-[9px] text-stone-500 font-bold uppercase tracking-wider text-center'>
                  ...
                  <span>
                    Szyfrowane połączenie i symulowane testowe środowisko
                    płatności.
                  </span>
                </div>
              </div>
            ...
            {step === 3 && (
              <div className='text-center py-20 space-y-6 flex flex-col items-center justify-center'>
                ...
                <div className='space-y-1.5'>
                  <h3 className='font-black text-lg text-stone-900 uppercase italic tracking-tighter'>
                    Autoryzacja płatności...
                  </h3>
                  <p className='text-xs text-stone-500 max-w-xs leading-relaxed font-semibold'>
                    Łączenie z bankiem i bezpiecznym operatorem transakcji.
                    Proszę nie odświeżać tej strony.
                  </p>
                </div>
              </div>
            )}
              ...
              <div className='space-y-6'>
                <div className='text-center space-y-3'>
                  ...
                  <p className='text-xs text-stone-600 max-w-sm mx-auto leading-relaxed font-bold uppercase tracking-wide'>
                    Płatność została pomyślnie autoryzowana. Twoje zamówienie
                    jest już przekazane do realizacji w naszym magazynie.
                  </p>
                </div>
                ...
                <div className='bg-white p-4 sm:p-5 rounded-none space-y-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-xs sm:text-sm'>
                  <div className='flex justify-between items-center pb-2 border-b-2 border-stone-200'>
                    ...
                    <strong className='font-mono text-stone-900 text-sm tracking-wide font-black'>
                      {createdOrder.id}
                    </strong>
                  </div>
                  <div className='flex justify-between items-center pb-2 border-b-2 border-stone-200'>
                    <span className='text-stone-500 uppercase tracking-wider font-bold text-[10px]'>
                      Numer nadania kuriera:
                    </span>
                    <strong className='font-mono text-[#E11D48] font-black'>
                  ...
                  <div className='flex justify-between items-center pb-2 border-b-2 border-stone-200'>
                    ...
                    <span className='text-right text-stone-800 font-black'>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <span className='text-emerald-700 font-black uppercase tracking-wider'>
                      Jutro (w ciągu 24h)
                    </span>
                  </div>
                </div>
                ...
                <div className='space-y-3 overflow-y-auto max-h-[140px] pr-1 scrollbar-thin'>
                  {cart.map((item) => (
                    <div
                      ...
                      className='flex gap-2.5 items-center justify-between text-xs'
                    >
                      <div className='truncate max-w-[150px]'>
                        ...
                        <span className='text-[9px] text-[#2B3E50] font-black uppercase tracking-wider block'>
                          Rozmiar: {item.size}
                        </span>
                      </div>
                      <span className='font-black text-stone-900'>
                        zł{(item.product.price * item.quantity).toFixed(2)}
                      </span>
                    </div>
                  ))}
                </div>
