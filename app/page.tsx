          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
            {loadingProducts && featured.length === 0
              ? Array.from({ length: 4 }).map((_, i) => (
                  <div
                    key={i}
                    className='flex flex-col bg-white border-2 border-black p-4 animate-pulse'
                  >
                    <div className='aspect-[3/4] w-full bg-stone-200 border-2 border-black' />
                    <div className='mt-4 h-4 bg-stone-200 w-3/4' />
